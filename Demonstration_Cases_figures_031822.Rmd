...
We can also break out the population into vulnerable groups--what it would look like if we fed all the seafood to children, for examples. Unfortunately don't have population breakdowns for pregnant and lactating women. These proportions are larger because it represents what would happen if ALL the current catch were provided to these groups; e.g. only children were eating fish. 
